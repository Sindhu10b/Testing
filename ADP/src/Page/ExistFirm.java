...
public class ExistFirm {
	...
	@FindBy(xpath="//body/div[@id='root']/div[3]/div[1]/div[2]/form[1]/div[1]/div[1]/div[5]/div[7]/div[2]/div[1]/div[2]")
	private WebElement payroll;
	
	@FindBy(xpath="//div[contains(text(),'Paychex')]")
	private WebElement paychex;
	...
	@FindBy(xpath="//span[contains(text(),'Create eSign Link')]")
